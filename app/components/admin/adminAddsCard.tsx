...
export default function AdminAdsCard() {
    ...
    return (
        <button className="flex flex-col w-full justify-center items-center relative">
            ...
            <p className="absolute text-white font-normal text-center bg-[#0699CA] px-2 rounded bottom-2">click anywhere to update ads</p>
        </button>
    );
}
